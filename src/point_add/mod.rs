...
// Delegated to cuccaro.rs submodule

// Cuccaro helpers delegated to cuccaro.rs submodule
...
// cuccaro_sub_fast delegated to cuccaro.rs submodule
...
fn kaliski_iteration_bulk_prefix3(
    ...
    let _rs_width_step9 = if iter_idx + 2 < u.len() {
        iter_idx + 2
    } else {
        u.len()
    };
