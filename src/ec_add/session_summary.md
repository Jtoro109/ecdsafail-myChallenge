...
across n=1..10 and n=256 cases. Including specific Eea-like dirty
patterns. Primitives are phase-clean in isolation.

## The peak-reduction blocker

Peak at our circuit is 2716q, driven by `state_a_mul1` (and 3 other
...
After the fix, wiring venting halve into backward Eea produces
...
of backward Eea produces residual phase? Likely an issue with
