//! Phase A of the SOTA rebuild: a reversible unconditional-Eea inversion
...
/// Classical reference: one unconditional Eea round with *wide* r, s.
...
/// Reversible wide-r Kim-style Eea iteration (forward only for now).
///
/// Register widths:
