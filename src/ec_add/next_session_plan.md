...
Wiring venting halve into backward Eea produces 1 phase batch out
...
Expected: state_a_mul1 peak 2716 → ~2460.

### 3. Check for other peak sites
Currently 4 phases at 2716 (state_a_mul1, state_a_mul2, bk_bulk_step6_7_8,
